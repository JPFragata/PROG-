# -*- coding: utf-8 -*-
"""
Created on Mon Sep  9 08:48:14 2024
...
# + (__add__)  recebe  como parâmetro um outro objeto da classe Video e constroi um
...
# * (__mul__)  recebe  como parâmetro um número inteiro n e constroi um
#     novo objeto da classe Video onde:
...
# += (__iadd__) recebe  como parâmetro um outro objeto da classe Video e   
...
# COMPARAÇÃO                         	
# ==  (__eq__)	recebe  como parâmetro um outro objeto da classe Video e 
#     retorna True  se tiver os mesmos valores de atributo e False caso contrário.
# !=	(__neq__)recebe  como parâmetro um outro objeto da classe Video e 
#     retorna False  se tiver os mesmos valores e True caso contrário.
# >	(__gt__)recebe  como parâmetro um outro objeto da classe Video e 
#     retorna True se tem maior duracao, False cc. 
# <=	(__le__) recebe  como parâmetro um outro objeto da Classe Video e 
