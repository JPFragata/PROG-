# -*- coding: utf-8 -*-
"""
Created on Mon Sep  9 07:31:21 2024
...
# Enunciado do Problema: Gerenciamento de Contas de Usuários
...
# Os usuários podem 
#     ativar e desativar suas contas, além de atualizar suas senhas quando necessário e se exibir


# A classe precisa atender aos seguintes requisitos:
# 1.	Criação de contas de usuário: Ao criar uma nova conta, o usuário deve fornecer um nome de usuário e uma senha. Por padrão, a conta criada deve estar inativa.
